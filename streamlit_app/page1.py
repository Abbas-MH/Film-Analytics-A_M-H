...
ratings_per_user['userId'] = ratings_per_user['userId'].astype(str)  # Pour affichage clair
top_users = ratings_per_user.head(10)

fig_users = px.bar(
    top_users,
    x="rating_count",
    y="userId",  # Corrigé ici : on utilise le nom de la colonne, pas une série
    orientation="h",
...
fig_users.update_layout(
    yaxis=dict(categoryorder="total ascending"),  # meilleur tri des catégories
    height=400,
