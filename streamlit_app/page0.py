...
st.markdown(
        """
        <a href="https://github.com/Abbas-MH/movie-backend-A_M-H" target="_blank">
...
st.markdown(
        """
        <a href="https://github.com/Abbas-MH/Film-Analytics-A_M-H" target="_blank">
            <button style="background-color: #28a745; color: white; padding: 10px 20px; border: none; border-radius: 8px; font-size: 16px;">
